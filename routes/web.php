...
Route::get('/staffs/update', 'StaffController@update')->name('staffs.update');
...
Route::get('/items/update', 'ItemController@update')->name('items.update');
...
Route::get('/rooms/update', 'RoomController@update')->name('rooms.update');
...
Route::get('/categories/update', 'CAtegoryController@update')->name('categories.update');
